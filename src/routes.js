...
import VehicleClassificationList from './pages/vehicle-classifications/VehicleClassificationList'
import VehicleClassificationCreate from './pages/vehicle-classifications/VehicleClassificationCreate'
import VehicleClassificationEdit from './pages/vehicle-classifications/VehicleClassificationEdit'
...
const routes = [
    ...
    },
    {
        ...
        component: <VehicleClassificationCreate />,
        roles: 'admin'
    },
    {
        path: '/vehicle-classifications',
        component: <VehicleClassificationList />,
        roles: 'admin'
    },
    {
        path: '/vehicle-classifications/:id/edit',
        component: <VehicleClassificationEdit />,
        roles: 'admin'
    },
    {
        path: '/roles/create',
